...
// 2
@interface InAppHelper () <SKProductsRequestDelegate, SKPaymentTransactionObserver>
@end
...
@implementation InAppHelper {
    ...
    RequestTransactionsCompletionHandler _transCompleteHandler;
...
- (void)requestTransactionsWithCompletionHander:(RequestTransactionsCompletionHandler)completionHandler {
    _transCompleteHandler = [completionHandler copy];
...
- (void)paymentQueueRestoreCompletedTransactionsFinished:(SKPaymentQueue *)queue {
    ...
    _transCompleteHandler(YES, queue.transactions);
    _transCompleteHandler = nil;
}
